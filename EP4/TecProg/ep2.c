...
int main(int ac, char **av) {
    ...
    while(comecar == 1 || recomeca_jogo(w) == 1) {
        PIC fundo_imagem, nave1_desenho, nave2_desenho, projeteis_desenho, game_over, num1, num2;
        ...
        int explosao_nave_1 = 10;
        int explosao_nave_2 = 10;
        ...
        while(tempo_de_execucao > epsolon) {
            ...
            switch(placar_2){
                case 0:
                num1 = ReadPic(w, "placar0.xpm", NULL);
                break;
                
                case 1:
                num1 = ReadPic(w, "placar1.xpm", NULL);
                break;
                
                case 2:
                num1 = ReadPic(w, "placar2.xpm", NULL);
                break;
                
                case 3:
                num1 = ReadPic(w, "placar3.xpm", NULL);
                break;
                
                case 4:
                num1 = ReadPic(w, "placar4.xpm", NULL);
                break;
                
                case 5:
                num1 = ReadPic(w, "placar5.xpm", NULL);
                break;
                    
                case 6:
                num1 = ReadPic(w, "placar6.xpm", NULL);
                break;
                    
                case 7:
                num1 = ReadPic(w, "placar7.xpm", NULL);
                break;
                
                case 8:
                num1 = ReadPic(w, "placar8.xpm", NULL);
                break;
                    
                case 9:
                num1 = ReadPic(w, "placar9.xpm", NULL);
                break;
            ...
            switch(placar_1){
                case 0:
                num2 = ReadPic(w, "placar0.xpm", NULL);
                break;
                
                case 1:
                num2 = ReadPic(w, "placar1.xpm", NULL);
                break;
                
                case 2:
                num2 = ReadPic(w, "placar2.xpm", NULL);
                break;
                
                case 3:
                num2 = ReadPic(w, "placar3.xpm", NULL);
                break;
                
                case 4:
                num2 = ReadPic(w, "placar4.xpm", NULL);
                break;
                
                case 5:
                num2 = ReadPic(w, "placar5.xpm", NULL);
                break;
                    
                case 6:
                num2 = ReadPic(w, "placar6.xpm", NULL);
                break;
                    
                case 7:
                num2 = ReadPic(w, "placar7.xpm", NULL);
                break;
                
                case 8:
                num2 = ReadPic(w, "placar8.xpm", NULL);
                break;
                    
                case 9:
                num2 = ReadPic(w, "placar9.xpm", NULL);
                break;
                ...
                PIC X = ReadPic(w, "X.xpm", NULL);
                PIC zero = ReadPic(w, "placar0.xpm", NULL);
                PIC zero1 = ReadPic(w, "placar0.xpm", NULL);

                game_over = ReadPic(w, "game_over.xpm", NULL);
                clock_t start_time_2 = clock();
                int passo_explosao = 1;
                while (passo_explosao < 6) {
                    while(clock() < start_time_2 + passo_explosao*300000) {
                            if (explosao_nave_1 < passo_explosao || explosao_nave_2 < passo_explosao){
                            if (explosao_nave_1 < passo_explosao) {
                                explosao_nave_1 = passo_explosao;
                            }
                            if (explosao_nave_2 < passo_explosao) {
                                explosao_nave_2 = passo_explosao;
                            }
                            if (passo_explosao == 1) {
                                if (explosao_nave_1 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave1_desenho_x+10, nave1_desenho_y+10, 0, 360*64, nave1_desenho_diam-20, nave1_desenho_diam-20, WNamedColor("Yellow"));
                                }
                                if (explosao_nave_2 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave2_desenho_x+10, nave2_desenho_y+10, 0, 360*64, nave1_desenho_diam-20, nave1_desenho_diam-20, WNamedColor("Yellow"));
                                }
                            }
                            else if (passo_explosao == 2) {
                                if (explosao_nave_1 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave1_desenho_x+10, nave1_desenho_y+10, 0, 360*64, nave1_desenho_diam-20, nave1_desenho_diam-20, WNamedColor("Dark Orange"));
                                }
                                if (explosao_nave_2 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave2_desenho_x+10, nave2_desenho_y+10, 0, 360*64, nave1_desenho_diam-20, nave1_desenho_diam-20, WNamedColor("Dark Orange"));
                                }
                            }
                            else if (passo_explosao == 3) {
                                if (explosao_nave_1 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave1_desenho_x, nave1_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Yellow"));
                                }
                                if (explosao_nave_2 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave2_desenho_x, nave2_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Yellow"));
                                }
                            }
                            else if (passo_explosao == 4) {
                                if (explosao_nave_1 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave1_desenho_x, nave1_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Dark Orange"));
                                }
                                if (explosao_nave_2 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave2_desenho_x, nave2_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Dark Orange"));
                                }
                            }
                            else if (passo_explosao == 5) {
                                if (explosao_nave_1 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave1_desenho_x-10, nave1_desenho_y-10, 0, 360*64, nave1_desenho_diam+20, nave1_desenho_diam+20, WNamedColor("Dark Red"));
                                    WFillArc(fundo_imagem, nave1_desenho_x-5, nave1_desenho_y-5, 0, 360*64, nave1_desenho_diam+10, nave1_desenho_diam+10, WNamedColor("Dark orange"));
                                    WFillArc(fundo_imagem, nave1_desenho_x, nave1_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Yellow"));
                                }
                                if (explosao_nave_2 == passo_explosao) {
                                    WFillArc(fundo_imagem, nave2_desenho_x-10, nave2_desenho_y-10, 0, 360*64, nave1_desenho_diam+20, nave1_desenho_diam+20, WNamedColor("Dark Red"));
                                    WFillArc(fundo_imagem, nave2_desenho_x-5, nave2_desenho_y-5, 0, 360*64, nave1_desenho_diam+10, nave1_desenho_diam+10, WNamedColor("Dark orange"));
                                    WFillArc(fundo_imagem, nave2_desenho_x, nave2_desenho_y, 0, 360*64, nave1_desenho_diam, nave1_desenho_diam, WNamedColor("Yellow"));
                                }
                            }
                            PutPic(w, fundo_imagem, 0, 0, 800, 1000, 0, 0);
                ...
                PutPic(w, zero1, 0, 0, 50, 150, 450, 360 );
                PutPic(w, num1, 0, 0, 50, 150, 500, 360 );
                PutPic(w, X, 0, 0, 60, 150, 360, 365 );
                PutPic(w, zero, 0, 0, 50, 150, 250, 360 );
                PutPic(w, num2, 0, 0, 50, 150, 300, 360);
                break;
            }
